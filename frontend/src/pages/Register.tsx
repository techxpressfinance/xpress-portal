      ...
      api.get(`/referrals/validate/${encodeURIComponent(refCode)}`)
        .then(({ data }) => {
          if (data.valid) {
            ...
            setInvitedRole(data.invited_role || null);
          }
        })
        .catch(() => {});
    }
        ...
        >
          ...
          {referrerName && (
            ...
            >
              ...
              <span className="text-[13px] text-primary">
                {invitedRole === 'broker'
                  ? <>Invited by <strong>{referrerName}</strong> to join as a broker</>
          ...
          {error && (
            <div
              ...
              style={{ animation: `fadeInUp 0.3s ${easing} both` }}
            >
              <ExclamationCircleIcon className="h-4 w-4 text-[#ff3b30] shrink-0 mt-0.5" />
