...
import { BuildingOfficeIcon, DocumentTextIcon, MagnifyingGlassIcon, UserIcon, XMarkIcon } from '@heroicons/react/24/outline';
        ...
        <div className="relative">
          <div className="flex items-center gap-3.5 px-5 py-4">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary/10">
              <MagnifyingGlassIcon className="h-[18px] w-[18px] text-primary" strokeWidth={2} />
            </div>
            <input
              ref={inputRef}
              type="text"
                    ...
                    return (
                      ...
                      >
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-chart-4/10">
                          <BuildingOfficeIcon className="h-4 w-4 text-chart-4" />
                        </div>
                        <div className="flex-1 min-w-0">
                    ...
                    return (
                      ...
                      >
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-chart-3/10">
                          <DocumentTextIcon className="h-4 w-4 text-chart-3" />
                        </div>
                        <div className="flex-1 min-w-0">
