...
- `frontend/AGENTS.md` — Detailed frontend architecture, component patterns, route structure
- `frontend/.Codex/docs/architectural_patterns.md` — Deep dive into auth flow, state management, CSS architecture
